...
-- CreateEnum
CREATE TYPE "ParticipantScreen" AS ENUM ('LOBBY', 'COUNTDOWN', 'QUESTION_MOTIVATION', 'QUESTION_READING', 'QUESTION_ACTIVE');

-- CreateEnum
CREATE TYPE "SpectatorScreen" AS ENUM ('LOBBY', 'QUESTION_MOTIVATION', 'QUESTION_READING', 'QUESTION_ACTIVE');

-- CreateEnum
CREATE TYPE "HostScreen" AS ENUM ('LOBBY', 'QUESTION_PREVIEW', 'QUESTION_READING', 'QUESTION_ACTIVE');
