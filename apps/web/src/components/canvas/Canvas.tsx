...
export default function Canvas(): JSX.Element {
    ...
    return (
        <div ref={canvasRef} style={{ color: currentQTemplate?.text_color, boxSizing: 'border-box' }}
            onClick={canvasTapHandler}
            className={cn("w-full h-full p-0.5 rounded-[12px] relative overflow-hidden", selectionMode === SELECTION_MODE.CANVAS && selectedStyles)}>
