...
export default function MiniCanvas({ template, question, currentQuestionIndex, questionIndex, setCurrentQuestionIndex, removeQuestion }: MiniCanvasProps) {
    ...
    return (
        <>
            ...
            {openMiniCanvasOptions && createPortal(
                <div
                    ref={dropdownRef}
                    className={cn(
                ...
                >
                    <Button onClick={() => handleRemoveQuestion()} className={cn("px-3 py-2 text-red-500 w-full bg-transparent hover:bg-transparent cursor-pointer", "flex items-center justify-between")}>
