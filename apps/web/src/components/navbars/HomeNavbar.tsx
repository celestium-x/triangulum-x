...
function BigHomeNavbar({
    ...
    return (
        <div className="absolute top-4 left-1/2 -translate-x-1/2 w-full max-w-5xl px-4 py-4 rounded-2xl shadow-lg border bg-gradient-to-b dark:from-[#242424] dark:via-neutral-900 dark:to-[#242424] from-neutral-200 via-neutral-100 to-neutral-200 hidden xl:flex">
