...
export default function FullScreenWarningPanel({ accept, deny }: FullScreenWarningPanelProps) {
    return (
        ...
        >
            <div className="text-red-600 text-xl">Warning!</div>
            ...
            <div className="w-full flex justify-end items-center gap-x-3 ">
                <Button variant={'destructive'} className="cursor-pointer" onClick={deny}>
                    Deny
                </Button>
                <Button className="cursor-pointer" onClick={accept}>
                    Accept
                </Button>
            </div>
        </UtilityCard>
