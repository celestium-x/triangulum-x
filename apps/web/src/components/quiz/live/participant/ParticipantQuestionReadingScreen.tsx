        ...
        <motion.div
            ...
            <div className='max-w-3xl h-[500px] sm:h-[550px] lg:h-[550px] flex flex-col items-center justify-start gap-y-20 flex-shrink-0'>
                <div className='flex-1 flex flex-col justify-between items-center my-12'>
                    <span className="text-2xl tracking-wider font-light leading-relaxed text-wrap">{"In a React component, what's the difference between using useEffect(() => {...}, []) and useLayoutEffect(() => {...}, [])? When would you prefer one over the other?"}</span>
                    <motion.span
