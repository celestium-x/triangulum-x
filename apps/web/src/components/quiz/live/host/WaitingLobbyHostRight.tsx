...
export default function WaitingLobbyHostRight() {
    const { quiz } = useLiveQuizStore();
    const { participantData } = useLiveParticipantStore();
    const [name, setName] = useState(participantData?.nickname);

    return (
        <div className="w-[36rem] max-w-[36rem] h-full flex flex-col justify-between bg-light-base dark:bg-neutral-900 rounded-l-xl border-l dark:border-neutral-700 border-neutral-200 z-[20] shadow-2xl px-6 py-6 dark:text-neutral-300 text-dark-primary">
