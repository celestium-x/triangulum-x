    ...
    return (
        <ToolTipComponent content="The code lets your audience join the presentation and expires in 2 days">
            <div className={cn("bg-neutral-200 px-3 py-1.5 rounded-md font-light",
                ...
                <div onClick={copyHandler} className="bg-dark-base text-light-base py-0.5 px-2 rounded-sm tracking-widest flex items-center justify-center gap-x-1 group">
                    {!copied ? (
                        ...
                        <CheckIcon className="max-w-0 group-hover:max-w-3 opacity-0 group-hover:opacity-100 transition-all duration-300 overflow-hidden" size={12} />
                    )}
                    <span>393729</span>
                </div>
            </div>
