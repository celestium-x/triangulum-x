    ...
    return (
        <div className="flex-1 h-full flex justify-center p-4 gap-x-4 min-w-0">
            ...
            <div className="flex flex-col items-start justify-start flex-1 gap-y-2 min-w-0">
                <UtilityCard className="bg-light-base dark:bg-dark-base/30 py-4 px-6 border border-neutral-300 dark:border-neutral-800 w-full min-h-[4rem] shadow-none rounded-sm">
                    <div className="relative flex items-center justify-between w-full">
                        <div className="flex items-center gap-3">
                            ...
                            <div className="flex items-center gap-1">
                                <Button variant={'ghost'} className="p-1 rounded text-neutral-400 hover:text-neutral-600 dark:hover:text-neutral-300 disabled:opacity-50">
                                    <ChevronLeft size={16} />
                                </Button>
                                <Button variant={'ghost'} className="p-1 rounded text-neutral-400 hover:text-neutral-600 dark:hover:text-neutral-300 disabled:opacity-50">
