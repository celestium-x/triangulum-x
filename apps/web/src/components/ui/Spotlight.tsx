...
export const Spotlight = ({
  ...
  const lightGradients = {
    gradientFirst: 'radial-gradient(68.54% 68.72% at 55.02% 31.46%, hsla(210, 100%, 40%, 0.2) 0%, hsla(210, 100%, 35%, 0.1) 50%, hsla(210, 100%, 30%, 0) 80%)',
    gradientSecond: 'radial-gradient(50% 50% at 50% 50%, hsla(210, 100%, 45%, 0.15) 0%, hsla(210, 100%, 35%, 0.1) 80%, transparent 100%)',
    gradientThird: 'radial-gradient(50% 50% at 50% 50%, hsla(210, 100%, 45%, 0.1) 0%, hsla(210, 100%, 35%, 0.05) 80%, transparent 100%)',
  };
