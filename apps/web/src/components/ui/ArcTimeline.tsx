  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        content:
          "Decentralized architecture – no single point of control, no unfair play.",
      },
      {
        icon: <FaCog size={20} />,
    ...
    steps: [
      {
        icon: <FaRocket size={20} />,
        content:
          "Spectator mode lets you watch epic quiz battles unfold in real time.",
      },
      {
        icon: <FaGlobe size={20} />,
        content:
    ...
    steps: [
      {
        icon: <FaStar size={20} />,
        content:
          "Create and publish your own quizzes with staked prize pools.",
      },
      {
        icon: <FaBolt size={20} />,
        content:
          "Invite participants through unique codes – no complicated onboarding.",
      },
      {
        icon: <FaRocket size={20} />,
    ...
    steps: [
      {
        icon: <FaCog size={20} />,
        content:
          "Earn crypto for your knowledge – the more you know, the more you win.",
      },
      {
        icon: <FaStar size={20} />,
        content:
    ...
    steps: [
      {
        icon: <FaCube size={20} />,
        content:
          "Team battles and tournaments for large-scale, high-stakes competitions.",
      },
      {
        icon: <FaMagic size={20} />,
        content:
          "Customizable rules, themes, and prize pools for unique quiz experiences.",
      },
    ],
  },
  {
    ...
    steps: [
      ...
      },
      {
        icon: <FaRocket size={20} />,
        content:
          `"Build on top of the game that rewards both brains and code."`,
      },
    ],
  },
  {
    ...
    steps: [
      {
        icon: <FaCog size={20} />,
        content:
          "Host approval triggers instant blockchain payouts to winners.",
      },
      {
        icon: <FaStar size={20} />,
        content:
          "All transactions are on-chain – no hidden fees, no delays.",
      },
      {
        icon: <FaGlobe size={20} />,
        content:
          `"Every game, every winner, every payout – recorded for all to see."`,
      },
    ],
  },
  {
    ...
    steps: [
      ...
      },
      {
        icon: <FaMagic size={20} />,
        content:
          "Integrating AI-generated quizzes for unlimited challenges.",
      },
    ],
  },
];
