    ...
    return (
        <div className="">
            ...
            >
                ...
                ></div>
                <div
                    className=" absolute inset-0 z-10 rounded-[inherit] shadow-[0_4px_4px_rgba(0,0,0,0.15),0_0_12px_rgba(0,0,0,0.08)]"
                ></div>
                <div
                    className=" absolute inset-0 z-20 rounded-[inherit] shadow-[inset_3px_3px_3px_0_rgba(255,255,255,0.45),inset_-3px_-3px_3px_0_rgba(255,255,255,0.45)]"
                ></div>

                <p className="text-white text-lg text-center z-30">
                    {children}
                </p>
            </div>
