...
export default function CustomFeatureComponent() {
    ...
    return (
        <div
            ref={ref}
            className="w-full flex mt-50 select-none h-full justify-center gap-x-10"
        >
            <div className="flex justify-end select-none gap-x-15">
                ...
                >
                    <span className={cn("tracking-widest transition-all duration-700 ease-out text-[40px] font-semibold", isVisible ? 'transform translate-x-0 opacity-100' : 'transform translate-x-16 opacity-0')} >
                        THINK • PLAY • WIN
                    </span>
                    ...
                    <div className='w-full'>
                        <p className="text-[22px] dark:text-neutral-300 font-light tracking-wide leading-9 text-justify pr-6">
                            ...
                            <span className="text-[#FF5C7D] font-light">Rise</span> through the ranks of
                            Solana’s fastest quiz arena. The future of quizzing: where curiosity
                            meets crypto, and learning transforms into real rewards.
                        </p>
                    </div>
                    ...
                    >
                        ...
                        <FaStar
                            ...
                            style={{
                                ...
                                animationIterationCount: startContinuousBounce ? 'infinite' : undefined
                            }}
                        />
                        <FaCommentAlt
                            className={cn(
