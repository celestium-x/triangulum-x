            ...
            {opensignInModal && (
                <OpacityBackground onBackgroundClick={() => setOpenSignInModal(false)}>
                    <UtilityCard className="max-w-md px-8 py-6 flex flex-col items-center justify-center space-y-6">
                        ...
                        <Button onClick={signinHandler} className="w-full flex items-center justify-center gap-3 px-6 py-[22px] text-sm font-medium bg-neutral-200 hover:bg-neutral-200/70 dark:bg-dark-primary/30 hover:dark:bg-dark-primary/40 rounded-md border-[1px] border-neutral-300 dark:border-neutral-700 ">
                            <Image
