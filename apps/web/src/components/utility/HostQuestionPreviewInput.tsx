...
export default function HostQuestionPreviewInput({
    className,
    value,
    color,
    onChange,
    ...
    return (
        ...
        >
            ...
            <input
                aria-label="Option"
                className="outline-none h-full w-full bg-transparent text-dark-base dark:text-neutral-600 placeholder:text-light-base dark:placeholder:text-dark-base"
                value={value}
