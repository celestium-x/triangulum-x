...
export default function ProfileMenu() {
    ...
    const dropdownContent = dropdown && mounted ? (
        <div 
            ref={dropdownRef}
        ...
        >
            <UtilityCard className="p-0 w-[10rem] overflow-hidden bg-white dark:bg-[#141414] border border-neutral-300 dark:border-neutral-700 shadow-lg">
                <div>
                    ...
                    <div className="px-4 py-[11px] text-xs font-normal text-red-500 dark:hover:bg-dark-primary/40 hover:bg-gray-200 flex justify-between cursor-pointer" onClick={handler}>
                        Sign Out
                        <IoMdLogOut size={14} />
                    </div>
                </div>
