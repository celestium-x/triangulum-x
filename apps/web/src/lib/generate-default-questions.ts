...
export function generateDefaultQuestions(): QuestionType[] {
    const questions: Omit<QuestionType, "id" | "quizId" | "imageUrl">[] = [
        ...
        },
        {
            ...
            options: ["InterPlanetary File System", "Internet Protocol for Files", "Infinite Public File Storage", "Instant Protocol File System"],
            correctAnswer: 0,
        ...
        },
        {
            ...
            options: ["Digital Autonomous Organization", "Decentralized Autonomous Organization", "Distributed Admin Organization", "Data Authority Office"],
            correctAnswer: 1,
        ...
        },
        {
            ...
            correctAnswer: 2,
            explanation: "Solidity is the most commonly used language for Ethereum smart contracts.",
            difficulty: 2,
            basePoints: 150,
            timeLimit: 30,
            orderIndex: 8,
        },
        {
            ...
            correctAnswer: 1,
            explanation: "Gas is the fee required to perform a transaction or execute a smart contract on Ethereum.",
            difficulty: 2,
            basePoints: 150,
            timeLimit: 30,
            orderIndex: 9,
