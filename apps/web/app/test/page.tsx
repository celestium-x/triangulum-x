...
export default function TriangleTimerBar({ timer = 30, className, bg = '#1e1e1e' }: TimerBarProps) {
    ...
    return (
        <div className={cn('w-full h-[100px] flex items-center justify-center z-[100]', className)}>
            <div className="w-[70%] relative">
                <svg viewBox="0 0 1000 140" width="100%" height="100%">
                    ...
                    <g clipPath="url(#triangle-clip)">
                        <rect x="0" y="0" height="140" fill={`${bg}99`} width={width} />
                    </g>
                </svg>
